...
class _MyMonitorState extends State<MyMonitor>{
  ...
  final List<String>listof=['Leaving Home','Entering Home','Going to Bed','Rise and Shine','Allow or Deny Entry','Add Member of Household', 'Front Gate'];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: new Container(
            child: new ListView.builder(itemBuilder: (_,int index)=>listMonitorItem(this.listof[index]),
